...
export default function ForumLayout({
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 text-slate-900 font-sans selection:bg-primary/20 selection:text-primary">
      {/* Background Decor (Giống trang Login nhưng nhạt hơn để không rối mắt khi đọc nội dung) */}
      ...
      {/* Glow effects - Màu xanh primary thay vì đỏ */}
      <div className="fixed top-0 left-0 -z-10 translate-x-[-50%] translate-y-[-50%] w-[500px] h-[500px] rounded-full bg-blue-400/20 blur-[100px]" />
      <div className="fixed bottom-0 right-0 -z-10 translate-x-[50%] translate-y-[50%] w-[500px] h-[500px] rounded-full bg-purple-400/20 blur-[100px]" />
